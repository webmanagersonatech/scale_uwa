...
function TimelineItem({ year, description, isLast = false }: TimelineItemProps) {
    return (
        <div className="relative pl-8 pb-8">
            {/* Timeline line */}
            {!isLast && (
                <div className="absolute left-[11px] top-6 bottom-0 w-0.5 bg-[#e0d6ce]"></div>
            )}
            {/* Timeline dot */}
            <div className="absolute left-0 top-1.5 w-6 h-6 rounded-full bg-[#AC1F2D] border-4 border-[#f5e8e0]"></div>

            <div className="bg-white rounded-lg p-6 shadow-sm border border-[#e0d6ce] hover:shadow-md transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    <span className="text-2xl font-bold text-[#AC1F2D] font-serif">{year}</span>
...
function TraditionsContent() {
    return (
        <motion.section
            ...
            animate="visible"
            className="mt-12"
            aria-labelledby="traditions-title"
        >
            <h2
                id="traditions-title"
                className="font-serif text-xl text-[#AC1F2D] font-bold mb-6 pb-3 border-b-2 border-[#f5e8e0]"
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {/* Tradition cards */}
                <div className="bg-[#f8f5f2] rounded-lg p-6 border border-[#e0d6ce]">
                    <div className="w-12 h-12 rounded-full bg-[#AC1F2D]/10 flex items-center justify-center mb-4">
                        <span className="text-[#AC1F2D] text-xl">🎓</span>
                    </div>
                    <h3 className="font-serif text-lg font-semibold text-gray-800 mb-2">The Tiger Legacy</h3>
                    <p className="text-[#5a5652] text-sm leading-relaxed">
                        UWA Tigers represent strength, determination, and community pride. Our athletic
                        traditions unite students, alumni, and fans across West Alabama.
                    </p>
                </div>
                ...
                <div className="bg-[#f8f5f2] rounded-lg p-6 border border-[#e0d6ce]">
                    ...
                    <h3 className="font-serif text-lg font-semibold text-gray-800 mb-2">Julia Tutwiler's Legacy</h3>
                    <p className="text-[#5a5652] text-sm leading-relaxed">
                        The pioneering educator and reformer who championed women's education in Alabama
                        continues to inspire UWA's commitment to opportunity and excellence.
                    </p>
                </div>

                <div className="bg-[#f8f5f2] rounded-lg p-6 border border-[#e0d6ce]">
                    <div className="w-12 h-12 rounded-full bg-[#AC1F2D]/10 flex items-center justify-center mb-4">
                        <span className="text-[#AC1F2D] text-xl">🏛️</span>
                    </div>
                    <h3 className="font-serif text-lg font-semibold text-gray-800 mb-2">Homecoming & Traditions</h3>
                    <p className="text-[#5a5652] text-sm leading-relaxed">
                        Annual homecoming celebrations bring together generations of Tigers to honor
                        shared memories and create new ones.
                    </p>
                </div>
                ...
                <div className="bg-[#f8f5f2] rounded-lg p-6 border border-[#e0d6ce]">
                    ...
                    <h3 className="font-serif text-lg font-semibold text-gray-800 mb-2">The Historic Campus</h3>
                    <p className="text-[#5a5652] text-sm leading-relaxed">
                        From the original academy buildings to modern facilities, UWA's campus reflects
                        nearly two centuries of educational heritage in Livingston.
                    </p>
                </div>
            </div>
        </motion.section>
