                ...
                <div className="flex flex-col lg:flex-row items-stretch gap-10 lg:gap-16">
                    ...
                    >
                        ...
                        <div className="relative z-10 px-6 py-6 lg:px-8 lg:py-8">
                            ...
                            {/* Section heading - REDUCED MARGIN */}
                            <motion.div variants={itemVariants}>
                                <h2 className="font-serif text-[24px] sm:text-[28px] lg:text-[32px] leading-[1.2] text-white mb-2">
                            ...
                            {/* Sub-heading - REDUCED MARGIN */}
                            <motion.div variants={itemVariants}>
                                <motion.p
                                    className="text-white text-xs sm:text-xs font-semibold tracking-[3px] uppercase mb-3 inline-block border-b-2 border-white pb-1.5"
                                    whileHover={{ x: 5 }}
                            ...
                            {/* Event Details - REDUCED SPACING */}
                            <motion.div variants={itemVariants} className="space-y-2.5 mb-4">
                                {/* Date */}
                                <div className="flex items-start gap-3 group">
                                    <div className="w-7 h-7 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center group-hover:bg-white/20 transition-colors duration-300 border border-white/10">
                                        <svg className="w-3.5 h-3.5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <p className="text-xs font-semibold text-white/90">Launch Date</p>
                                        <p className="text-xs text-white/70">3 July 2026</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div>
                                        <p className="text-xs font-semibold text-white/90">Programme Type</p>
                                        <p className="text-xs text-white/70">International Pathway • 1+1 Model</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            {/* Decorative elements */}
                            <motion.div
                                className="absolute bottom-4 right-4 flex gap-2 z-0"
                    ...
                    >
                        {/* Clean divider line */}
                        <motion.div
                            className="absolute left-0 top-0 w-1 h-12 bg-gradient-to-b from-red-500 to-red-400 rounded-full z-10"
                            variants={frameVariants}
                        />

                        {/* Description with enhanced styling */}
                        <motion.p
                            className="text-sm text-gray-700 leading-relaxed mb-10 text-justify font-normal tracking-wide relative z-10 pl-6 border-l-2 border-red-200/50"
                            variants={itemVariants}
                        >
                            The 1+1 International Pathway Programme offers a unique opportunity to earn a Master of Science in Data Science from the University of West Alabama. This innovative model combines one year of foundational study with one year of specialized training, preparing you for a successful global career in data science.
                        </motion.p>

                        <Link href="/events/sona-uwa-launches-1-1-international-pathway-programme-in-m-s-data-science">
                            <motion.button
                                variants={itemVariants}
                                className="group relative inline-flex items-center gap-3 text-sm font-medium text-red-600 hover:text-red-700 transition-colors duration-300 self-start z-10 pl-6"
                                whileHover={{ x: 5 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                <span className="relative">
                                    View Event
                                    <span className="absolute -bottom-1 left-0 w-0 h-[2px] bg-gradient-to-r from-red-500 to-red-400 group-hover:w-full transition-all duration-300"></span>
                                </span>
                        ...
                        <motion.div
                            className="absolute bottom-0 right-0 flex gap-2 z-0"
                            variants={dotGridVariants}
                        >
                            {[...Array(4)].map((_, i) => (
                        ...
                        <motion.div
                            className="absolute -bottom-10 -right-10 w-32 h-32 bg-gray-100 rounded-full blur-2xl z-0"
                            variants={frameVariants}
                        />
                    </motion.div>
                </div>
